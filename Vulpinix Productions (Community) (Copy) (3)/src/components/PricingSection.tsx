      ...
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          {plans.map((plan, index) => (
            <Card 
              key={index}
              className={`relative bg-gradient-to-br ${plan.gradient} border ${plan.border} backdrop-blur-xl rounded-3xl p-8 hover:scale-105 transition-all duration-300 ${plan.popular ? 'shadow-2xl shadow-purple-500/30' : ''}`}
            >
              {plan.popular && (
