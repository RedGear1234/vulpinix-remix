...
function buildCallQueue(adAccountId, campaignIds, adSetIds, adIds) {
  ...
  const acctEndpoints = adAccountId ? [
    { label: 'adaccount info',            path: adAccountId,                 params: { fields: 'id,name,account_status,currency,timezone_name,spend_cap,balance,funding_source_details' } },
    ...
    { label: 'adaccount/insights (day)',   path: `${adAccountId}/insights`,   params: { fields: 'impressions,clicks,spend,reach,cpc,cpm,ctr', date_preset: 'last_30d', level: 'account' } },
    { label: 'adaccount/insights (week)',  path: `${adAccountId}/insights`,   params: { fields: 'impressions,clicks,spend,reach', date_preset: 'last_7d', level: 'account' } },
    { label: 'adaccount/insights (month)', path: `${adAccountId}/insights`,   params: { fields: 'impressions,clicks,spend,reach,actions', date_preset: 'this_month', level: 'account' } },
    { label: 'adaccount/reachestimate',   path: `${adAccountId}/reachestimate`, params: { currency: 'USD' } },
    ...
    { label: 'adaccount/saved_audiences', path: `${adAccountId}/saved_audiences`, params: { fields: 'id,name', limit: 10 } },
    { label: 'adaccount/targeting_browse',path: `${adAccountId}/targetingbrowse`, params: { include_headers: false, limit: 10 } },
    { label: 'adaccount/broadtargetingcategories', path: `${adAccountId}/broadtargetingcategories`, params: { custom_audiences_folders: false } },
    { label: 'adaccount/delivery_estimate', path: `${adAccountId}/delivery_estimate`, params: { optimization_goal: 'REACH' } },
    { label: 'adaccount/adsvolume',       path: `${adAccountId}/adsvolume`,   params: {} },
    { label: 'adaccount/connectionobjects', path: `${adAccountId}/connectionobjects`, params: { limit: 5 } },
  ] : [];
