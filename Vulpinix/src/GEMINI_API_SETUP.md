...
2. Find line with: `const GEMINI_API_KEY = "YOUR_GEMINI_API_KEY_HERE";`
3. Replace `YOUR_GEMINI_API_KEY_HERE` with your actual API key
4. Example: `const GEMINI_API_KEY = "AIzaSyD1234567890abcdefghijk";`
...
2. Accepts upload requests from your frontend
3. Calls Gemini API server-side
...
3. Sent to Gemini 1.5 Flash model with vision capabilities
4. AI analyzes the visual content
5. Generates contextually relevant caption and hashtags

### Video Analysis
1. User uploads a video
2. Text-based prompt is used (due to video processing limitations)
3. AI generates marketing-focused content
4. Returns professional captions and hashtags
...
2. 5-7 relevant hashtags that maximize reach and engagement
3. Professional yet engaging tone suitable for business/marketing
...
- Check if you replaced `YOUR_GEMINI_API_KEY_HERE` in `/pages/UploadPage.tsx`
- Verify API key is active in [Google AI Studio](https://makersuite.google.com/app/apikey)
- Check browser console (F12) for detailed errors

### Error: "API request failed: 400"
**Common causes**:
1. **Image format not supported** - Convert HEIC/HEIF to JPEG
2. **File too large** - Try compressing the image (recommended < 4MB)
3. **Invalid API endpoint** - Check the API URL is correct
4. **Malformed request** - Check browser console for request details
...
2. Modify the `text` field in the request
3. Add more specific instructions about your industry
4. Include brand tone/voice requirements
