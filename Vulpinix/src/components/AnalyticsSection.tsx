...
export function AnalyticsSection() {
  const platforms = [
    { name: "Instagram", icon: Instagram, color: "from-pink-500 to-purple-500", likes: 2670, comments: 794, bars: [28, 42, 35, 50, 38] },
    { name: "Facebook", icon: Facebook, color: "from-blue-600 to-blue-400", likes: 1370, comments: 462, bars: [22, 34, 44, 30, 40] },
    { name: "LinkedIn", icon: Linkedin, color: "from-blue-500 to-cyan-500", likes: 342, comments: 178, bars: [20, 26, 32, 24, 36] },
  ];
