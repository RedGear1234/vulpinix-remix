...
export default function AuthPage() {
  ...
  const [btnWidth, setBtnWidth] = useState(window.innerWidth < 480 ? 300 : 368);

  useEffect(() => {
    const handleResize = () => {
      setBtnWidth(window.innerWidth < 480 ? 300 : 368);
    };
  ...
  return (
    <>
      <style>{`
        ...
        /* Social buttons */
        .auth-socials { display: flex; flex-direction: column; gap: 8px; margin-bottom: 20px; }
        .auth-soc-btn {
          ...
          {authMode === "login" && (
            <form onSubmit={handleLogin}>
              ...
              <div className="auth-socials">
                <div style={{ width: "100%", display: "flex", justifyContent: "center", minHeight: "40px" }}>
                  <GoogleLogin 
